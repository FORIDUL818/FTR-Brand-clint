...
function Login() {
  return (
    <div className=" bg-[#a5b1c2] flex h-screen justify-center items-center">
  
<form className="w-[400px] bg-[#130f40]  p-8 rounded-xl shadow-xl">
  <h1 className="w-full text-center p-4 mb-6 uppercase text-3xl font-semibold text-white bg-gradient-to-r from-[#130f40] to-[#6C63FF] rounded-t-lg">Login Form</h1>
  ...
  <div className="mt-6 text-center">
    ...
    <button 
      ...
      onClick={() => { /* switch to registration form */ }}
    >
      Register
    </button>
  </div>
